...
- **Self-contained reference** — the repo stands on its own; the whole platform can be read and reasoned about end-to-end without chasing external module sources.
