...
ADRs exist because reviewers need to distinguish intentional design from copy-paste. They also exist because future maintainers will forget why the current shape was chosen.
